            ...
            <div class="regbox" id="register_box">
                <form action="/doregister" method="post" name="formUser" onsubmit="return submitPwdInfo();">
                    ...
                    <div class="phone_step1">
                        ...
                        <div class="inputbg">
                            <label class="labelbox"> <input type="text" name="username" id="username" placeholder="6-16位任意数字/字母/下划线" value="{{old('username')}}" /> </label>
                            <span class="t_text">用户名</span>
                            <span class="error_icon">{{$errors->first('username')}}</span>
                        </div>
                        ...
                        <div class="inputbg">
                            ...
                            <span class="error_icon">{{$errors->first('eamail')}}</span>
                        </div>
                        <div class="err_tip" id="email_notice">
                            <em></em>
                        </div>
                        <div class="inputbg">
                            <label class="labelbox"> <input type="password" name="password" id="password" onblur="check_password(this.value);" onkeyup="check_password(this.value);checkIntensity(this.value);" placeholder="至少6位" /> </label>
                            <span class="t_text">密码</span>
                            <span class="error_icon">{{$errors->first('password')}}</span>
                        </div>
                        <div class="err_tip" id="password_notice">
                            <em></em>
                        </div>
                        <div class="inputbg">
                            <label class="labelbox"> <input name="repassword" type="password" id="conform_password" onblur="check_conform_password(this.value);" onkeyup="check_conform_password(this.value);" placeholder="确认密码" /> </label>
                            <span class="t_text">确认密码</span>
                            <span class="error_icon">{{$errors->first('repassword')}}</span>
                        </div>
                        ...
                        <div class="inputbg inputcode dis_box clearfix">
                            ...
                            <img src="{{url('/admin/code')}}" alt="captcha" onclick="this.src='{{url('admin/code')}}?Math.random()'" class="icode_image code-image chkcode_img" onclick="this.src='/login/captcha?'+Math.random()" />
                        </div>
                        <div class="err_tip">
                            <em></em>
                        </div>
