...
@section('css')
    ...
    <script type="text/javascript" async="" src="/static/homes/common/js/unjcV2.js"></script>
    <script type="text/javascript" async="" src="/static/homes/common/js/jquery-1.9.1.min.js"></script>

    <script src="/static/homes/common/js/base.min.js"></script>

    <script type="text/javascript" async="" src="/static/homes/common/js/jquery.statData.min.js"></script>
    <script type="text/javascript" async="" src="/static/homes/common/js/xmst.js"></script>
    ...
    <link rel="stylesheet" href="/static/homes/common/css/list.min.css">
        ...
        <div class="filter-list-wrap">
            <dl class="filter-list clearfix filter-list-row-3">
                ...
                @foreach($cates as $cate)
                    <dd><a href="/list?id={{$cate->id}}" data-stat-id="b120dec55d40e599" onclick="_msq.push([&#39;trackEvent&#39;, &#39;a5543b161410aa8b-b120dec55d40e599&#39;, &#39;//search.mi.com/search_手机-10&#39;, &#39;pcpid&#39;]);">{{$cate->name}}</a></dd>
                @endforeach
            </dl>
...
<script src="/static/homes/common/js/xmsg_ti.js"></script>

<script>
    var SITE_ID = "Search";
    var SEARCH_WORDS = "手机";
</script>
<script src="/static/homes/common/js/goodsList.min.js"></script>
    <script>
    var _msq = _msq || [];
