  ...
  <li class="category-item"><a class="title" href="/list?id=1">{{$val->name}}<i class="iconfont"></i></a>
   <div class="children clearfix children-col-2" style="width:530px;">
    <ul class="children-list children-list-col children-col-1">
        ...
        @if($keys<6)
            <li class="star-goods"><a class="link" href="/detail?{{$vals->id}}"><img class="thumb" src="{{url($vals->img)}}" width="40" height="40" alt="" /><span class="text">{{$vals->name}}</span></a></li>
        @endif
        @endforeach
    </ul>
    <ul class="children-list children-list-col children-col-1">
     @foreach($val->suv as $keyss=>$valss)
        @if($keyss>5)
     <li class="star-goods"><a class="link" href="/detail?{{$valss->id}}"><img class="thumb" src="{{url($valss->img)}}" width="40" height="40" alt="" /><span class="text">{{$valss->name}}</span></a></li>
        @endif
    @endforeach
    </ul>
   </div></li>
