...
<div id="main" class="layout">
    <div class="nl-content">
        <div class="nl-logo-area">
            <a href="/"><img src="/static/homes/common/image/logo.gif" width="55"></a>
        </div>
            ...
            <div class="ng-form-area show-place">
                <form name="formLogin" action="/dologin" method="post">
                    ...
                    <div class="enter-area img-code-area">
                    	<input name="code" style="width: 150px;float:left;" type="text" class="enter-item first-enter-item" placeholder="验证码">
