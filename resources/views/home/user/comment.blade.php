                        ...
                        <div class="uc-nav-box">
                            ...
                            <div class="box-bd">
                                <ul class="uc-nav-list">
                                    ...
                                    <li class="active">
                                        <a href="/useraddress">收货地址</a><br><br>
                                        <a href="/userdata">个人资料</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="xm-goods-list-wrap">
                                    ...
                                    @if($request->input('filter')==1||empty($request->input('filter')))
                                        ...
                                        <li class="xm-goods-item">
                                            ...
                                            <div class="actions">
                                                <a class="btn btn-primary btn-small J_btnComment" data-gid="2161000055" href="/comment?id={{$v->id}}&order_id={{$v->order_id}}&gid={{$v->good_id}}">去评价</a>
                                            </div>
                                        </li>
                                        @endforeach
                                        @endif
