...
@section('css')
    ...
    <link rel="stylesheet" href="/static/homes/common/css/checkout.min.css" />
            ...
            <div class="checkout-box">
                <div class="section section-address">
                    ...
                    <div class="section-body clearfix" id="J_addressList">
                        ...
                        @endif
                        <!-- addresslist end -->
                       <a href="/add" class="address-item address-item-new" id="J_newAddress" > <i class="iconfont">&#xe609;</i>
                            添加新地址
                        </a>
                    ...
                    <div class="section-body">
                        <ul class="goods-list" id="J_goodsList">
                            ...
                            <li class="clearfix">
                                ...
                                <div class="col col-price">{{$v->sku->price}}元 x {{$v->goods_num}}</div>
...
<script src="/static/homes/common/js/address_all.js"></script>     
<script src="/static/homes/common/myjs/fnmodel.js"></script>    
<script src="/static/homes/common/myjs/order.js"></script>       
@endsection