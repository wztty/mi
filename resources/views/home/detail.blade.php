...
@section('css')
    ...
    <script src="/static/homes/common/js/jquery-1.9.1.min.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="/static/homes/common/css/goods-detail.min.css" />
@endsection
                ...
                <div class="span13  J_mi_goodsPic_block goods-detail-left-info">
                    <div class="goods-pic-box  " id="J_mi_goodsPicBox">
                        <div class="goods-big-pic J_bigPicBlock">
                            <img src="{{$datax[0]->showImg}}" class="J_goodsBigPic" id="J_BigPic" />
                        </div>
                        ...
                        <div class="goods-small-pic clearfix">
                            <ul id="goodsPicList">
                                ...
                                <li class="current"><img src="{{$res->img}}" /> </li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    ...
                    <form action="##" method="get" id="yourformid">
                        ...
                        <dl id="J_goodsInfoBlock">
                            ...
                            <dd class="goods-info-head-price clearfix">
                                <b class="J_mi_goodsPrice">{{$datax[0]->price}}</b>
                                <i>&nbsp;元</i>
                                <del>
                            ...
                            <dd style="margin-top: 15px;">
                                ...
                                <div class="clearfix">
                                   ...
                                   @foreach($datax as $vel)

                                    <div class="attr" name="attr" title="{{$vel->title}}" id="attr" price="{{$vel->price}}">
                            ...
                            @foreach($datax as $row)
                                <dd class="goods-info-head-colors clearfix" >
                                    <div class="hidden" num="{{$row->attr}}" name="hidden">
                                        <span class="goods-info-head-colors clearfix">选择 颜色</span >
                                        @foreach($datax as $rows)
                                        <div  class="float">
                                            <div>
                                                <a href="" class="smallAttr" name="color" title="{{$rows->color}}" data-stat-id="bd7cb1fe26f82654" id="color">{{$rows->color}}</a>
                                            </div>
                                        </div>
                                     @endforeach
                                    </div>
                ...
                <ul class="main-block">
                    ...
                    <li class="item-rainbow-3 groom-content">
                        <dl>
                            ...
                            <div class="groom-content-userImage">
                                <img src="/static/homes/common/image/u6bPscBa4MZjpi_90.jpg" alt="" />
                            </div>
                    ...
                    <li class="item-rainbow-2 groom-content">
                        <dl>
                            <dt>
                            <div class="groom-content-userImage">
                                <img src="/static/homes/common/image/head_3.png" alt="" />
                            </div>
                            <div class="groom-content-userName">
                                海涛
                            </div>
                            ...
                            <li class="item-rainbow-1" data-id="134117576">
                                ...
                                <dl class="user-comment">
                                    ...
                                    {{--<dd class="user-comment-answer">--}}
                                        {{--<img class="self-image" src="/static/homes/common/image/head_4.png" alt="" />--}}
