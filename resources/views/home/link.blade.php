...
<head>
    ...
    <style type="text/css">
        .tab{width:80%;height:auto;margin:0 auto;}
        #link tr td{font-size: 18px;}
        #link tr td:hover{color:blue;font-size:24px;}
        .form{width:400px;height:auto;margin-left:200px;}
        .title{width: 100%;height:40px;margin: 0 auto;color:red;}
        .form input{margin-top:5px;}
        .btn{color:#fff;margin-left:68px;border-radius:8px;background:red;}
    </style>
    @show
    @section('myCss')
    @show
    ...
    <div class="site-topbar">
        <div class="container">
            ...
            <?php 
                    ...
                    $user = \App\Http\Controllers\home\UserController::gainUsername(session('username'));
            ?>
            <div class="topbar-info" id="J_userInfo">
                <span class="user">
...
@section('content')
<div class="tab">
    <table width="800" align="center" id="link">
    <tr>
...
<div class="form">
    <div class="title"><h3>友情链接申请</h3></div>
    <form action="/insertlink" method="post">
        网站标题：<input type="text" name="title"><br>
        网站网址：<input type="text" name="url"><br>
        <input type="hidden" name="status" value="0">
        <input type="submit" value="申请" size="20" class="btn">
        {{csrf_field()}} 
    </form>
</div>
@show
