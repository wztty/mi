                ...
                <form action="/doregister" method="post" name="formUser" onsubmit="return submitPwdInfo();">
                    ...
                    <div class="phone_step1">
                        ...
                        <div class="inputbg">
                            ...
                            <button type="submit" style="width:100px" class="btn_reg_1 submit-step labelbox">发送验证码</button>
                        ...
                        <div class="inputbg">
                            <label class="labelbox"> <input type="text" name="code" id="code" placeholder="验证码" value="{{old('code')}}"/> </label>
                            <span class="t_text">验证码</span>
                            <span class="error_icon">{{$errors->first('code')}}</span>
                        </div>
                        <div class="inputbg">
                            <label class="labelbox"> <input type="password" name="password" id="password" placeholder="密码" value="{{old('password')}}"/> </label>
                            <span class="t_text">密码</span>
                            <span class="error_icon">{{$errors->first('password')}}</span>
                        </div>
                        <div class="inputbg">
                            <label class="labelbox"> <input type="password" name="repassword" id="repassword" placeholder="重发密码" value="{{old('repassword')}}"/> </label>
                            <span class="t_text">重发密码</span>
