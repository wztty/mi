                ...
                <div class="mws-form-inline">
                    <div class="mws-form-row" style="width: 490px;">
                        ...
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="title" value="">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">原价</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="falsePrice" value="">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">现价</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="price" value="">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">颜色</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="color" value="">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">型号</label>
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="attr" value="">
                        </div>
                    </div>
                    ...
                    <div class="mws-form-row" style="width: 400px;" >
                        ...
                        <div class="mws-form-item">
                            <input type="text" class="grid_6" title="" name="stock" value="">
                        </div>
                    </div>
                    <div class="mws-form-row" style="width: 490px;" >
                        <label class="mws-form-label">状态</label>
                        <div class="mws-form-item">
                            <input type="radio" title="" name="status" value="1" >上架
